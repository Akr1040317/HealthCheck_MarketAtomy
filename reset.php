...
$conn= mysqli_connect('localhost','marketat_akshatR','akshat03','marketat_verify-user', 3306);
    if(isset($_POST['submit'])){
        ...
        if($password != $confirmpassword){
            ...
            $query = "update users set password='$hashed' where email='rastogia@ufl.edu'";
            mysqli_query($conn, $query);
            $query = "delete from password_reset where email='rastogia@ufl.edu'";
            mysqli_query($conn, $query);
    ...
    <div class="container">
      <div class="card login-card">
        <div class="row no-gutters">
          <div class="col-md-5">
            <img src="assets/images/AI.jpg" alt="login" class="login-card-img">
          </div>
          <div class="col-md-7">
            <div class="card-body">
                ...
                <div class="card-body px-lg-5 pt-0">
                  ...
                  <div class="brand-wrapper">
                    <img src="assets/images/BHA.png" alt="logo" class="logo">
                        ...
                        <a  href="http://healthcheck.marketatomy.com/"><button class="btn btn-outline-info btn-rounded btn-block my-4 waves-effect z-depth-0" name="signin">Go to Sign-in</button></a>
